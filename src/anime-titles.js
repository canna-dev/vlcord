...
/**
 * Common patterns that might suggest a title is an anime
 */
const animePatterns = [
  /\b(anime|manga)\b/i,
  /\b(kun|chan|san|sama|senpai|sensei)\b/i,
  /(subbed|dubbed|sub|dub)/i,
  /\b(ova|oav)\b/i
];
...
export function formatAnimeTitle(showData) {
  ...
  console.log('Formatted anime data:', formattedShowData);
